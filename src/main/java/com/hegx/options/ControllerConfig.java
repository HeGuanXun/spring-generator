...
public class ControllerConfig {
	...
	public ControllerConfig initDefaultValue() {
		tableItem.add(new TableAttributeKeyValue("f_find", "getList", "查询所有{C}数据的方法"));
		tableItem.add(new TableAttributeKeyValue("f_getById", "getById", "通过id查询{C}数据的方法"));
