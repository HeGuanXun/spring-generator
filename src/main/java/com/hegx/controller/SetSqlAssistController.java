...
import com.hegx.models.TableAttributeKeyValueEditingCell;
...
public class SetSqlAssistController extends BaseController {
	...
	private void initLanguage() {
		...
		tdDescribe.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_TD_DESCRIBE));
		lblAddCustomProperty.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_LBL_ADD_CUSTOM_PROPERTY));
		lblDescribe.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_LBL_DESCRIBE));
		...
		txtValue.promptTextProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_TXT_VALUE));
		txtDescribe.promptTextProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_TXT_DESCRIBE));
