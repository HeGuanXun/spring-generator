...
import com.hegx.models.TableAttributeKeyValueTemplateEditingCell;
...
public class SetCustomController extends BaseController {
	...
	private void initLanguage() {
		lblTips.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_LBL_TIPS));
		tdClassName.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_COMMON_CLASS_NAME));
		tdSuffix.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_COMMON_SUFFIX));
		tdPackageName.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_COMMON_PACKAGE_NAME));
		tdTemplate.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_COMMON_TEMPLATE_NAME));
		lblAddCustomProperty.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_LBL_ADD_CUSTOM_PROPERTY));
		lblPackageName.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_LBL_PACKAGE_NAME));
		lblClassName.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_LBL_CLASS_NAME));
		...
		txtPackageName.promptTextProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_TXT_PACKAGE_NAME));
		txtClassName.promptTextProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_TXT_CLASS_NAME));
	...
	public void loadConfig(CustomConfig config) {
		...
		if (config != null && config.getTableItem() != null) {
			config.getTableItem().forEach(v -> {
				...
				attribute.getTemplate().promptTextProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_CBO_TEMPLATE));
	...
	public void onAddPropertyToTable(ActionEvent event) {
		...
		comboBox.promptTextProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_CBO_TEMPLATE));
