...
import com.hegx.models.TableAttributeEntityEditingCell;
...
public class SetEntityAttributeController extends BaseController {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		StringProperty property = SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_TBL_TIPS);
	...
	public void init() {
		...
		// 添加右键删除属性
		StringProperty property = SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_TBL_MENU_ITEM_DELETE);
		...
		item.setOnAction(event -> {
			...
			StringProperty delConfirmP = SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_TBL_MENU_ITEM_DELETE_CONFIRM);
	...
	private void initLanguage() {
		tdIsCreate.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_ENTITY_TD_CREATE));
		tdColumn.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_ENTITY_TD_COLUMN));
		tdSqlType.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_ENTITY_TD_SQL_TYPE));
		tdJavaType.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_ENTITY_TD_JAVA_TYPE));
		tdField.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_ENTITY_TD_FIELD));
		lblAddCustomProperty.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_LBL_ADD_CUSTOM_PROPERTY));
		lblKey.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_ENTITY_LBL_KEY));
		lblValue.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_ENTITY_LBL_VALUE));
		btnSaveConfig.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_BTN_SAVE_CONFIG));
		btnAddProperty.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_BTN_ADD_PROPERTY));
		btnConfirm.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_BTN_CONFIRM));
		btnCancel.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_BTN_CANCEL));
		txtKey.promptTextProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_TXT_KEY));
		txtKey.promptTextProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_ENTITY_TXT_KEY));
		txtValue.promptTextProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_ENTITY_TXT_VALUE));
		chkOverrideFile.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_CHK_OVERRIDE_FILE));
		lblTemplate.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_LBL_TEMPLATE));
		cboTemplate.promptTextProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_CBO_TEMPLATE));
		lblTableAlias.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_ENTITY_LBL_TABLE_ALIAS));
		txtTableAlias.promptTextProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_ENTITY_TXT_TABLE_ALIAS));
		lblPrimaryKey.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_ENTITY_LBL_PRIMARY_KEY));
		txtPrimaryKey.promptTextProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_ENTITY_TXT_PRIMARY_KEY));
		chkFieldCamel.textProperty().bind(SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_CHK_FIELD_CAMEL));
	}
	/**
	 * 初始化表格属性
	 */
	...
	public void loadTablePropertyValues(List<TableAttributeEntity> attr) {
		...
		for (TableAttributeEntity entity : attr) {
			if (chkFieldCamel.isSelected()) {
				entity.setTdField(StrUtil.onlineToCamel(entity.getTdColumnName()));
			}
	...
	public void onCamel(ActionEvent event) {
		...
		if (chkFieldCamel.isSelected()) {
			for (TableAttributeEntity entity : list) {
				entity.setTdField(StrUtil.onlineToCamel(entity.getTdField()));
				tblPropertyValues.add(entity);
			}
			tblProperty.setItems(tblPropertyValues);
		} else {
	...
	public void onCancel(ActionEvent event) {
		StringProperty property = SpringGeneratorApplication.LANGUAGE.get(LanguageKey.SET_BTN_CANCEL_TIPS);
